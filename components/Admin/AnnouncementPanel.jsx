    ...
    <div className="w-full bg-slate-950/90 border border-slate-800/80 rounded-2xl p-5 sm:p-6 text-slate-100 shadow-xl backdrop-blur-md">
      ...
      <div className="flex flex-wrap items-center justify-between border-b border-slate-800/80 pb-5 mb-5 gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-base font-bold text-white tracking-tight">Hero Section Announcements & Ads</h3>
            <p className="text-xs text-slate-400 mt-0.5">Add, update, or remove dynamic promotional text banners.</p>
          </div>
        </div>
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center py-16 text-slate-500 space-y-2">
          ...
          <p className="text-xs font-medium">Loading announcements...</p>
        </div>
        ...
        <div className="py-14 text-center text-xs text-slate-500 bg-slate-900/40 rounded-2xl border border-slate-800/60 flex flex-col items-center justify-center space-y-2">
          ...
          <p>No announcements created yet. Click &quot;Add New Ad&quot; above.</p>
        </div>
      ) : (
    ...
    >
      <div className="min-w-0 flex-1 space-y-1.5">
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <strong className="text-sm font-bold text-white tracking-tight truncate">{ad.title}</strong>
          <span
            className={`text-[10px] font-semibold px-2 py-5.5 rounded-md ${
              ad.active
        ...
        <p className="text-xs text-slate-400 line-clamp-1 leading-relaxed">{ad.description}</p>
      </div>
        ...
        >
          ...
          >
            ...
            <form onSubmit={handleSave} className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-300 mb-1.5">Headline Title *</label>
                <input
                  type="text"
                  required
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                ...
                <div>
                  <label className="block text-xs font-semibold text-slate-300 mb-1.5">Target URL</label>
                  <input
                    type="text"

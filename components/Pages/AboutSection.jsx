...
export default function AboutSection() {
  ...
  // 🟢 Agar data load ho raha hai toh GearLoader render hoga
  if (loading) {
    return (
      <section className="about section relative overflow-hidden py-24 bg-[#050c18] border-t border-b border-slate-800/80 text-slate-100 flex items-center justify-center">
        <GearLoader fullScreen={false} text="Loading Profile..." />
      </section>
    );
  }

      ...
      try {
        ...
        if (res.ok && json.data) {
          setContactInfo({
            ...
            inquiryEmail: json.data.inquiryEmail || "afptechsupport@gmail.com",
          });
        }
      } catch (err) {
            ...
            >
              ...
              >
                {loading ? (
                  ...
                  >
                    {/* 🟢 Dedicated GearLoader Component integrated inside button */}
                    <GearLoader fullScreen={false} text="" />
                    <span style={{ fontSize: "1.4rem", color: "#38bdf8" }}>

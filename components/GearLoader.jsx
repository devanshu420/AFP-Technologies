...
export default function Loading() {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/30 backdrop-blur-md pointer-events-auto">
      <div className="flex flex-col items-center justify-center p-6 rounded-2xl">
        {/* Aapka Gear Loader Image */}
        <div className="relative w-24 h-24 flex items-center justify-center">
          <img
            src="/gear-loader.png"
            alt="Loading..."
            className="w-40 h-40 object-contain animate-[spin_3s_linear_infinite]"
          />
        </div>
        <p className="mt-3 text-xs font-semibold text-sky-400 tracking-wider">
          Loading...
        </p>
      </div>
    </div>
...
// export default function GearLoader({ fullScreen = false, text = "Loading..." }) {
//   return (
//     <div
//       style={{
//         display: "flex",

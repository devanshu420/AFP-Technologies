...
export default function EquipmentRangeClient({ products = [] }) {
  ...
  */
  ...
  const handleImageEnter = (image, product) => {
    if (!image) return;
  ...
  */
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="bg-[#071b32] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
          ...
          <p className="mt-3 max-w-xl text-sm text-slate-300 leading-6">
            Explore our complete range of industrial machinery and food
            ...
            {products.map((product) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className="relative w-full h-40 sm:h-44 bg-slate-100 overflow-hidden cursor-zoom-in"
                    onMouseEnter={() =>
                      handleImageEnter(image, product)
                    }
                  >
                    {image ? (
                      <img
      ...
      {previewImage && (
        <div
          className="hidden lg:flex fixed inset-0 z-[100] items-center justify-center bg-black/20 backdrop-blur-[1px]"
        ...
        >
          ...
          <div
            className="relative w-[55vw] max-w-[900px] h-[70vh] bg-white rounded-2xl shadow-2xl overflow-hidden"
